 ...
 */
function validateType(propName: string, value: any, propSchema: any): void {
 ...
 * @param propSchema 屬性結構定義
 */
function validateNumberRange(propName: string, value: number, propSchema: any): void {
 ...
 * @param propSchema 屬性結構定義
 */
function validateStringFormat(propName: string, value: string, propSchema: any): void {
 ...
 * @param propSchema 屬性結構定義
 */
function validateArray(propName: string, value: any[], propSchema: any): void {
 ...
 * @param propSchema 屬性結構定義
 */
function validateObject(propName: string, value: Record<string, any>, propSchema: any): void {
