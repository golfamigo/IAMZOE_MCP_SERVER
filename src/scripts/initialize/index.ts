...
import { scanToolDefinitions } from '../../utils/toolScanner';
 ...
 */
function generateSampleArguments(schema: any): string {
...
async function initialize() {
  ...
  try {
    ...
    await generateToolDefinitionsTemplate(TOOL_DEFS_OUTPUT, TOOLS_DIR);
